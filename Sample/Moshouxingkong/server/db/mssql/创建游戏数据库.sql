...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[GameUserRef]') AND type in (N'U'))
BEGIN
CREATE TABLE [GameUserRef](
	[UserId] [int] IDENTITY(1666666,1) NOT NULL,
	[UserName] [varchar](256) NOT NULL,
	[UserType] [varchar](256) NOT NULL,
	[UserBirthday] [datetime] NULL,
 CONSTRAINT [PK_GameUserRef] PRIMARY KEY CLUSTERED
(
	[UserId] ASC
